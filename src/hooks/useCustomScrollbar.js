...
export default function useCustomScroller(
	...
	// const [previous, setPrevious] = useState(0) // DEBUG
	...
	// const skewScrolling = () => {
	//   const el = scrollerRef.current;
	// 	// console.log(content[1].ref)

	//   const difference = el.scrollTop - previous * 100
	//   // const difference = skewConfigs.current - skewConfigs.rounded
	//   const acceleration = difference / content[1].ref.current.scrollWidth
	//   const velocity = acceleration;
	//   const skew = velocity * 7.5;
	//   console.log(skew)
	//   content[1].ref.current.style.transform = `skewY(${skew*3}deg)`
	//   setPrevious(el.scrollTop)
	// 	requestAnimationFrame(() => skewScrolling())
	// }
	// END DEBUG
