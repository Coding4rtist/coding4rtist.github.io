...
import { FooterSocialLinks, FooterSocialLink } from '@styles/footerStyles'
import { AboutSocialLinks, AboutSocialLink } from '@styles/aboutStyles'
...
export function AboutSocials({ onCursor }) {
	const tempLinks = AllSocials.map((social, i) => {
		return (
			<AboutSocialLink key={i}>
				<a
					href={social.url}
	...
	return <AboutSocialLinks>{tempLinks}</AboutSocialLinks>
}

export function FooterSocials({ onCursor }) {
	// const link = data[mainLinks[index]]

	const tempLinks = MainSocials.map((social, i) => {
		return (
			<FooterSocialLink key={i}>
				<a
					href={social.url}
					onMouseEnter={() => onCursor('hovered')}
					onMouseLeave={onCursor}
	...
	return <FooterSocialLinks>{tempLinks}</FooterSocialLinks>
	// return (
...
export default { FooterSocials, AboutSocials }
